...
import { chunk, postJSON } from "@/lib/client";
import { countPages, filesToPageImages, getPdfPageCount } from "@/lib/pdf";
...
export default function Page() {
  ...
  return (
    <div className="flex h-dvh overflow-hidden bg-paper">
      <Sidebar collapsed={collapsed} onToggle={() => setPinOpen(!collapsed)} />
      <div className="flex min-w-0 flex-1 flex-col">
        <TopBar onBack={stage === "results" ? back : undefined} />
